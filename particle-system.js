...
class ParticleSystem {
    ...
    updateParticle(particle) {
        ...
        if (this.mouseInView && !this.reducedMotion) {
    ...
    bindEvents() {
        ...
        // Add mousedown to ensure position is updated during clicks
        document.addEventListener('mousedown', handleMouseMove, { passive: true });
